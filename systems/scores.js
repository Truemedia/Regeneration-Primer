...
* @overview Core Regeneration Primer system used as CRUDL API of scores relevant to players
...
define(["./jQ.ui.progressbar", "./Crafty"], function(jQuery, Crafty) {
	return scores = {
		...
		setScore: function(old_score, score_incrementer, player_number_as_word){
			...
			scores.getJSONkeyFromJSONvalue("systems/numbers_as_words.json", player_number_as_word, new_score)
		},

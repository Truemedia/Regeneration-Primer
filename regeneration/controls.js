...
* @overview Core Regeneration Primer class used for binding HID (Human Interface Devices) to internal application methods
...
define(["./jQuery"], function(jQuery)
{
	Controls = {
		...
		{
			console.log("Showing item " + item_number);

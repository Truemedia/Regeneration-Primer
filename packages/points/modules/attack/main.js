...
define(["Bootstrap", "KO"], function(jQuery, ko)
{
	Attack = {
        ...
        {
            // Defaults
            var value = ko.observable( Attack.points ),
                step = ko.observable( parseInt(Config.get('points::attack.default_step')) ),
                min_value = ko.observable( parseInt(Config.get('points::attack.min_value')) ),
                max_value = ko.observable( parseInt(Config.get('points::attack.max_value')) );
        ...
        allocate_points: function(universal_points)
        {
            ...
            var exchange_rate = parseInt( Config.get('points::attack.exchange_rate') ),
                potential_points = Math.floor(universal_points / exchange_rate),
                max_points = parseInt( Config.get('points::attack.max_value') );

...
define(["Bootstrap", "KO"], function(jQuery, ko)
{
	Currency = {
        ...
        {
            // Defaults
            var value = ko.observable( Currency.points ),
        ...
        allocate_points: function(universal_points)
        {
            ...
            var exchange_rate = parseInt( Config.get('points::currency.exchange_rate') ),
                potential_points = Math.floor(universal_points / exchange_rate),
                max_points = parseInt( Config.get('points::currency.max_value') );

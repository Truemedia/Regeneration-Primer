...
(function (root, factory)
{
	...
	{
    	module.exports = factory(null, null, null, null, null, null, null, require('backbone'));
	}
	else if (typeof define === 'function' && define.amd) // AMD
	{
    	define([
			"stache!./templates/partial", "i18n!./nls/strings", "Config", "Lang", "Game", "Package", "Bootstrap", "Backbone"
      		...
      		return (root.returnExportsGlobal = factory(template, nls, Config, Lang, Game, Package, jQuery, Backbone));
    	});
  	}
...
} (this, function (template, nls, Config, Lang, Game, Package, jQuery, Backbone)
	{
	/** 
     * Stage package
     * @namespace stage
